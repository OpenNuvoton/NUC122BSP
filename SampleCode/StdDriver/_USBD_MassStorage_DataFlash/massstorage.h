/******************************************************************************
 * @file     massstorage.h
 * @brief    NUC122 series USB mass storage header file
 * $Revision: 3 $
 * $Date: 15/01/07 9:46a $
 *
 * @note
...
/******************************************************************************/
/** @addtogroup NUC122_USBD_Mass_Exported_Struct NUC122 USBD Mass Exported Struct
  NUC122 USBD Mass Specific Struct
  @{
*/
...
/*-------------------------------------------------------------*/
#define DATA_FLASH_STORAGE_SIZE    (4*1024)   /* Configure the DATA FLASH storage size */
