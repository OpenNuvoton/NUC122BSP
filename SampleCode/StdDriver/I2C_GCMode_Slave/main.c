...
void I2C1_Init(void)
{
    ...
    I2C_SetSlaveAddr(I2C1, 0, 0x15, 1);   /* Slave Address : 0x15 */
    I2C_SetSlaveAddr(I2C1, 1, 0x35, 1);   /* Slave Address : 0x35 */
    I2C_SetSlaveAddr(I2C1, 2, 0x55, 1);   /* Slave Address : 0x55 */
    I2C_SetSlaveAddr(I2C1, 3, 0x75, 1);   /* Slave Address : 0x75 */
...
int32_t main(void)
{
    ...
    */
    ...
    printf("\n");
    printf("+-----------------------------------------------------------------+\n");
    printf("| NUC122 I2C Driver Sample Code (Slave) for access Slave (GC Mode)|\n");
    printf("|                                                                 |\n");
