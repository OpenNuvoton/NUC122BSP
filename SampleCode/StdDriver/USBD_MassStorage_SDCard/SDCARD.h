 ...
 * @file     sdcard.h
 * @version  V1.00
 * @brief    NUC122 series SD Card driver header file
 *
 * @note
...
/** @addtogroup NUC122_Library NUC122 Library
  @{
*/

/** @addtogroup NUC122_SDCARD SDCARD Library
  @{
*/

/** @addtogroup NUC122_SDCARD_EXPORTED_CONSTANTS SDCARD Library Exported Constants
  @{
*/
...
/*@}*/ /* end of group NUC122_SDCARD_EXPORTED_CONSTANTS */

/** @addtogroup NUC122_SDCARD_EXPORTED_STRUCTS SDCARD Library Exported Structs
  @{
*/
...
/*@}*/ /* end of group NUC122_SDCARD_EXPORTED_STRUCTS */

/** @addtogroup NUC122_SDCARD_EXPORTED_FUNCTIONS SDCARD Library Exported Functions
  @{
*/
...
/*@}*/ /* end of group NUC122_SDCARD_EXPORTED_FUNCTIONS */


/*@}*/ /* end of group NUC122_SDCARD */

/*@}*/ /* end of group NUC122_Library */
