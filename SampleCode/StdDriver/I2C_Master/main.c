...
void I2C_MasterTx(uint32_t u32Status)
{
    ...
    else
    {
        ...
        {
            I2C_SET_DATA(I2C1, (uint32_t)((g_u8DeviceAddr << 1) | 0x01));   /* Write SLA+R to Register I2CDAT */
            I2C_SET_CONTROL_REG(I2C1, I2C_I2CON_SI);
        }
        else
        {
...
int32_t main(void)
{
    ...
    */
    printf("\n");
    printf("+--------------------------------------------------------+\n");
    printf("| NUC122 I2C Driver Sample Code(Master) for access Slave |\n");
    printf("|                                                        |\n");
    ...
    I2C1_Read_Write_SLAVE(0x15);
    I2C1_Read_Write_SLAVE(0x35);
    I2C1_Read_Write_SLAVE(0x55);
    I2C1_Read_Write_SLAVE(0x75);
    printf("SLAVE Address test OK.\n");

    /* Access Slave with address mask */
    printf("\n");
    printf(" == Mask Address ==\n");
    I2C1_Read_Write_SLAVE(0x15 & ~0x01);
    I2C1_Read_Write_SLAVE(0x35 & ~0x04);
    I2C1_Read_Write_SLAVE(0x55 & ~0x01);
    I2C1_Read_Write_SLAVE(0x75 & ~0x04);
