 ...
 * @return      None
 *
 * @details     The Timer0 default IRQ, declared in startup_NUC122.s.
 */
 ...
 * @return      None
 *
 * @details     The Timer2 default IRQ, declared in startup_NUC122.s.
 */
 ...
 * @return      None
 *
 * @details     The Timer3 default IRQ, declared in startup_NUC122.s.
 */
...
void SYS_Init(void)
{
    ...
    /* Enable external 12 MHz XTAL, LXT-32K */
    ...
    CLK->CLKSEL1 = CLK_CLKSEL1_UART_S_PLL |
                   CLK_CLKSEL1_TMR0_S_HXT | CLK_CLKSEL1_TMR1_S_HCLK | CLK_CLKSEL1_TMR2_S_HIRC | CLK_CLKSEL1_TMR3_S_LXT;
